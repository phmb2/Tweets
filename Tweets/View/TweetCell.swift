...
//  Tweets
//
//  Created by Pedro Barbosa on 01/06/20.
...
class TweetCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        let captionStack = UIStackView(arrangedSubviews: [nameInfoLabel, captionLabel])
    ...
    func configure() {
        ...
        nameInfoLabel.attributedText = viewModel.userInfoText
